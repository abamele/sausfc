...
class KocaeliLife extends StatefulWidget {
    KocaeliLife({super.key, required this.academyLifeModel});
    AcademyLifeModel academyLifeModel;
  @override
  State<KocaeliLife> createState() => _KocaeliLifeState();
}

class _KocaeliLifeState extends State<KocaeliLife> {
  ...
  Widget build(BuildContext context) {
    ...
    KocaeliGalleryProvider kocaeliGalleryProvider = Provider.of(context);
    kocaeliGalleryProvider.getKocaeliGalleryData();
    return Scaffold(
      appBar: AppBar(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: kocaeliGalleryProvider.getKocaeliGalleryDataList.length,
                      itemBuilder: (context, index) {
                        final data= kocaeliGalleryProvider.getKocaeliGalleryDataList[index];
