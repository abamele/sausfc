...
class DefenderProvider with ChangeNotifier {
  List<PlayerProfileModel> defenderDataList = [];

  void getDefenderData() async {
    ...
    defenderDataList = newList;
    notifyListeners();
  }

  List<PlayerProfileModel> get getDefenderDataList {
    return defenderDataList;
  }
}