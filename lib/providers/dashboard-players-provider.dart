...
class DashboardPlayersProvider with ChangeNotifier {
  List<PlayerProfileModel> dashboardPlayersDataList = [];

  void getDashboardPlayersData() async {
    List<PlayerProfileModel> newList = [];

    QuerySnapshot reviewDefenderValue =
    await FirebaseFirestore.instance.collection("DashboardPlayers").get();
    ...
    dashboardPlayersDataList = newList;
    notifyListeners();
  }

  List<PlayerProfileModel> get getDashboardPlayerDataList {
    return dashboardPlayersDataList;
  }
}
