...
import 'package:saus_fc/models/academy-life-model.dart';
...
class EskisehirLife extends StatefulWidget {
     EskisehirLife({super.key, required this.academyLifeModel});
     AcademyLifeModel academyLifeModel;
  @override
  State<EskisehirLife> createState() => _EskisehirLifeState();
}

class _EskisehirLifeState extends State<EskisehirLife> {
  ...
  Widget build(BuildContext context) {
    EskisehirGalleryProvider eskisehirGalleryProvider = Provider.of(context);
    eskisehirGalleryProvider.getEskisehirGalleryData();
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: eskisehirGalleryProvider.getEskisehirGalleryDataList.length,
                      itemBuilder: (context, index) {
                        final data= eskisehirGalleryProvider.getEskisehirGalleryDataList[index];
