...
class MidfieldProvider with ChangeNotifier {

  List<PlayerProfileModel> midfieldDataList = [];

  void getMidfieldData() async {
    ...
    midfieldDataList = newList;
    notifyListeners();
  }

  List<PlayerProfileModel> get getMidfieldDataList {
    return midfieldDataList;
  }
}